/* أيقونات المنصة — طقم Lucide (رخصة ISC — https://lucide.dev)
   مضمّنة محلياً بالكامل، بلا أي طلب شبكة وقت التشغيل.

   لماذا تُرك النمط ثنائي الدرجة (Duotone) السابق: كان يرسم خلف كل أيقونة شكلاً
   مصمتاً بشفافية ٢٠٪. عند الحجم الحقيقي في الأزرار (١٩ بكسل) لا يُقرأ ذلك
   الشكل كطبقة تصميم بل كهالة رمادية حول الأيقونة — تبدو ضبابية، وتزداد سوءاً
   فوق الأزرار الملوّنة وفي الوضع الداكن. النمط الحالي خطوط مصمتة بلا أي طبقة
   شفافة، فيبقى الشكل حادّاً عند أي حجم.
...
(function () {
  ...
  // غلاف موحّد: شبكة ٢٤، خطّ بسماكة ٢ ونهايات مدوّرة، بلا تعبئة وبلا أي طبقة
  // شفافة — وهو سبب وضوح الأيقونات مقارنة بالنمط السابق.
